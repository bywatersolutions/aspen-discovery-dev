...
#### Aspen LiDA
#### Aspen PWA
- Create generic SelfCheckSettings to allow ability for LiDA and the progressive Web Application to both set up settings with the same structure. ([DIS-2643](https://aspen-discovery.atlassian.net/browse/DIS-2643)) (*IT*)
#### Automated Testing

...
function getUpdates26_10_00(): array {
	...
	return [
		...
		'aggregate_aspen_usage' => [
			...
			'continueOnError' => false,
			'sql' => [
				// 1. Clear out the scratch table a previous attempt may have left behind so this update can be run
				//    again safely. aspen_usage_old is deliberately *not* dropped here, it holds the only copy of the
				//    history if a previous attempt died after step 3.
